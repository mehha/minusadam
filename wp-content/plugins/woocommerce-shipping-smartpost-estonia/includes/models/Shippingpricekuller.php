 ...
 * @author Matis
 */
class Eabi_Woocommerce_Itella_Model_Shippingpricekuller extends Eabi_Woocommerce_Postoffice_Model_Shippingprice {
    ...
    public function getFeeFromSize($productSize, $costs = array()) {
        ...
        sort($size);
        if ($size[0] > 60 || $size[1] > 60 || max($size) > 120) {
            return false;
        }
