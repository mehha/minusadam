 ...
 * @author Matis
 */
class Eabi_Woocommerce_Itella_Block_Countryprice extends Eabi_Woocommerce_Postoffice_Block_Array {
    ...
    protected function _construct() {
        ...
        $this->_columns = array(
            ...
            array(
                'label' => __('XS price', WC_Itella_Smartpost_Estonia::PLUGIN_TEXT_DOMAIN),
                'name' => 'xs_price',
                'type' => 'text',
                'class' => '',
                'style' => '',
            ...
            array(
                'label' => __('S price', WC_Itella_Smartpost_Estonia::PLUGIN_TEXT_DOMAIN),
                'name' => 's_price',
                'type' => 'text',
                'class' => '',
                'style' => '',
            ...
            array(
                'label' => __('M price', WC_Itella_Smartpost_Estonia::PLUGIN_TEXT_DOMAIN),
                'name' => 'm_price',
                'type' => 'text',
                'class' => '',
                'style' => '',
            ...
            array(
                'label' => __('L price', WC_Itella_Smartpost_Estonia::PLUGIN_TEXT_DOMAIN),
                'name' => 'l_price',
                'type' => 'text',
                'class' => '',
                'style' => '',
            ...
            array(
                'label' => __('XL price', WC_Itella_Smartpost_Estonia::PLUGIN_TEXT_DOMAIN),
                'name' => 'xl_price',
                'type' => 'text',
                'class' => '',
                'style' => '',
